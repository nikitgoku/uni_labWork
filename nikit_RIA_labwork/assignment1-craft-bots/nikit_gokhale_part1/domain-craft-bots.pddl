(define (domain craft-bots)
    ...
    (:functions
        ...
        (build_resources_at_site ?n - nodes) - number		; buidl resources at the site
        (construction_status ?b - building ?n - nodes) - number	; construction status of the building
    )
    ...
    ;; Action to make the actor dig at a mine
    ...
    (:durative-action deposite_resource
        ...
        :effect (and 
            ...
            (at end (increase (build_resources_at_site ?ni) 1))             ; build resource count at the site increases
    ...
    ;; Action to finish the construction of building at the node
